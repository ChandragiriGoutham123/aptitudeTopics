...
class alongAndAgainst:
    ...
    for i in range(number_of_inputs):
        ...
        inputs = input(
            "enter to find '1.speed of boat(where downstream time  and upstream time given)' or '2.speeds of streams and boats(where same or different distances given) and"
            " time for another distances' or '3.speed of stream(distance different)': ")
